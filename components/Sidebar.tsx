  ...
  return (
    <div>
      <div 
        ...
        // correct way to take the state and chenge it in react
      >
            ...
            <div className="xl: border-b-2 border-gray-200 xl:pb:4">
              <Link href="/">
                <div className={normalLink}>
                  ...
                  {/* hidden on small devices and visible on larger devices */}
                </div>
              </Link>
            </div>
            {!userProfile && (
              <div className='px-2 py-4 hidden xl:block'>
                ...
                <div className='pr-4 '>
                  <button className='bg-white text-lg text-[#F51997]'>
                  <GoogleLogin 
                    clientId=''
                    buttonText="Login"
                    // render ={(renderProps) => {
